...
function appendResultRow(sourceName, data) {
  ...
  if (data.recommendation === 'shipped_parcel') {
    recHtml = `<span style="color: var(--success); background: var(--success-bg); border: 1px solid rgba(12,176,130,0.3); padding: 3px 8px; border-radius: 99px; font-weight: 700; font-size:11px; display:inline-flex; align-items:center; gap:5px;"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 5 12"/></svg>Shipped this parcel (Safe)</span>`;
  } else if (data.recommendation === 'low_risk_shipped') {
    recHtml = `<span style="color: #ee7540; background: var(--gold-dim); border: 1px solid var(--b-gold); padding: 3px 8px; border-radius: 99px; font-weight: 700; font-size:11px; display:inline-flex; align-items:center; gap:5px;"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>Confusion / Low Risk</span>`;
  } else {
    recHtml = `<span style="color: var(--error); background: var(--error-bg); border: 1px solid rgba(229,62,62,0.3); padding: 3px 8px; border-radius: 99px; font-weight: 700; font-size:11px; display:inline-flex; align-items:center; gap:5px;"><svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>Do not shipped this address</span>`;
  }
